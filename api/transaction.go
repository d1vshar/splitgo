...
func (Api *Api) GetTransactionsHandler(c echo.Context) error {
	trxs, err := Api.App.DB().GetTransactionsForUser("0ec02773-f863-400f-9c45-2a30b1e167b7")
...
func (Api *Api) GetSettlementGraphHandler(c echo.Context) error {
	trxs, err := Api.App.DB().GetTransactionsForUser("0ec02773-f863-400f-9c45-2a30b1e167b7")
	...
	return SuccessResponse(c, http.StatusOK, util.GenerateSettlementGraph(trxs))
}
...
func (Api *Api) CreateTransactionHandler(c echo.Context) error {
	...
	res, err := Api.App.DB().CreateNewTransaction("0ec02773-f863-400f-9c45-2a30b1e167b7", t)
...
func (Api *Api) UpdateTransactionHandler(c echo.Context) error {
	...
	res, err := Api.App.DB().UpdateTransaction(trx_id, "0ec02773-f863-400f-9c45-2a30b1e167b7", t)
...
func (Api *Api) DeleteTransactionHandler(c echo.Context) error {
	...
	delete_err := Api.App.DB().DeleteTransaction(trx_id, "0ec02773-f863-400f-9c45-2a30b1e167b7")
...
func (Api *Api) RegisterTransactionRoutes(g *echo.Group) {
	...
	tg.GET("/sgraph", Api.GetSettlementGraphHandler)
